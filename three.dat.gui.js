...
/***/ function(module, exports, __webpack_require__) {
	...
	var NumberController = function (_Controller) {
	  ...
	  NumberController.prototype.readOnly = function readOnly(v) {
	    if (arguments.length === 0) v = true;
			this.__readOnly = v;
	    return this;
	  };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var NumberControllerBox = function (_NumberController) {
	  ...
	  function NumberControllerBox(object, property, params) {
	    ...
	    _this2.__input = document.createElement('input');
	    _this2.__input.setAttribute('type', 'text');
			_this2.__input.readOnly = _this2.__readOnly;
	    ...
	    _dom2.default.bind(_this2.__input, 'keydown', function (e) {
	      ...
	      else if (e.keyCode === 107 || e.keyCode === 38) { // plus/up
					var step = e.shiftKey ? _this.__step * 100 : _this.__step;
					if (e.ctrlKey) step /= 10; // make smaller steps
					_this.setValue(parseFloat(_this.__input.value, 10) + step);
					e.preventDefault(); // consumed this key
				}
	      else if (e.keyCode === 109 || e.keyCode === 40) { // minus/down
					var step = e.shiftKey ? _this.__step * 100 : _this.__step;
					if (e.ctrlKey) step /= 10; // make smaller steps
					_this.setValue(parseFloat(_this.__input.value, 100) - step);
					e.preventDefault(); // consumed this key
				}
